...
The results presented here reveal significant variation in predictive metrics among different fish species. Specifically, for Perch, Pike, and Roach, distinct models emerged as the most effective in predicting their overall weight. Automation was key in determining the model of best fit.
